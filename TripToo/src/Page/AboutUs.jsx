...
const AboutUs = () => {
  return (
    <section id="about-us" className="bg-white text-[#0f1c2e] max-w-5xl mx-auto my-12 p-8 sm:p-10 rounded-lg shadow-2xl transition-all duration-300 transform hover:scale-[1.005] px-4">
      <div className="text-center mb-12">
        <h1 className="text-5xl font-extrabold text-[#0f1c2e] mb-4 relative pb-4">
        ...
        <p className="text-xl text-gray-700 italic">"Your Journey, Simplified."</p>
      </div>

      <div className="grid md:grid-cols-2 gap-8 mb-12">
        <div className="bg-gray-50 p-6 rounded-lg shadow-inner">
          <h2 className="text-3xl font-bold text-[#0f1c2e] mb-4 flex items-center">
            <span className="text-green-500 text-4xl mr-3">🚀</span> Our Mission
          </h2>
        ...
        <div className="bg-gray-50 p-6 rounded-lg shadow-inner">
          <h2 className="text-3xl font-bold text-[#0f1c2e] mb-4 flex items-center">
            <span className="text-green-500 text-4xl mr-3">🌟</span> Our Vision
          </h2>
          <p className="text-lg text-gray-700 leading-relaxed">
      ...
      <div className="mb-12">
        <h2 className="text-3xl font-bold text-center text-[#0f1c2e] mb-6">
          The TripToo Story
        </h2>
      ...
      <div className="text-center mb-12">
        <h2 className="text-3xl font-bold text-[#0f1c2e] mb-6">Connect With Us!</h2>
        <div className="flex justify-center space-x-6 text-green-500">
          <a href="https://facebook.com/yourtriptoo" target="_blank" rel="noopener noreferrer"
             className="text-5xl hover:text-green-600 transition-colors duration-300"
             title="Facebook">
             <FaFacebookF />
          </a>
      ...
      <div className="text-center mt-12 pt-8 border-t border-gray-200">
        <h2 className="text-3xl font-bold text-[#0f1c2e] mb-4">Ready for Your Next Adventure?</h2>
        <p className="text-lg text-gray-700 mb-6">
          Explore our wide range of travel kits designed to make your journeys effortless and enjoyable.
        </p>
        <a href="/shop"
           className="inline-block bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-8 rounded-full text-xl transition-all duration-300 transform hover:scale-105 shadow-lg">
          Shop Our Kits Now!
        </a>
      </div>
    </section>
