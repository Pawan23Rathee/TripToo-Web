...
const AboutUs = () => {
  return (
    <section id="about-us" className="bg-white text-[#0f1c2e] max-w-5xl mx-auto my-12 p-8 sm:p-10 rounded-lg shadow-2xl transition-all duration-300 transform hover:scale-[1.005]">
